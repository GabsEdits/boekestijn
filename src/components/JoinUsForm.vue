            ...
            <form id="tg">
                <div class="form-group">
                   <h1 style="color:black">FORM BOEKESTIJN</h1>
                    <div class="form-label"><b>Required to fill in the field*</b></div>
                    <label class="form-label">First and last name*</label>
                    <input type="text" name="name" required id="name" class="form-control" placeholder="Сергей Петров">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    <label class="form-label">GSM number*</label>
                    <input type="tel" name="tel" required id="tel" class="form-control" placeholder="+373xxxxxxxx">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    <label class="form-label">Email*</label>
                    <input type="email" name="email" required id="email" class="form-control" placeholder="example@gmail.com">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                    <label class="form-label">Experience category CE (how many years)<a style="color:red"></a></label>
                    <input type="text" name="exp" required id="exp" class="form-control" placeholder="0, 1, 2...">
                </div>
                <div class="form-group">
                    <label class="form-label">About me (optional)</label>
                    <textarea type="text" name="self" class="form-control" cols="auto" rows="3"></textarea>
                </div>
                <!-- /.form-group -->
