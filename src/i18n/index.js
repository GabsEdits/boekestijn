...
const messages = {
    en: {
      header: {
        callus: 'Call Us',
        quickoffice: 'Our Main <br>Office: <i><a href="https://goo.gl/maps/Ydmkt3j1Z1PnpCM1A?coh=178571&amp;entry=tt">Strada Liviu Deleanu 13 (Et. 4), Chișinău, Republica Moldova</a></i>',
        locations: 'Locations',
        language: 'Language'
      },
      mainarea: {
      ...
      benefits: {
        ...
        benefitglobe: 'Work under the contract and work visa directly with employer',
        benefitlanguage: 'Flexible training for new drivers with average experience',
        benefitbook: 'Company provides English courses to enable drivers communication with clients and administration. English or German language courses to conversational levels',
        benefitcap: 'Trainings and courses',
        benefitgift: 'Internal bonuses',
        benefitmap: 'Our entire fleet are monitored and managed by our own TMS. Developed with the main priority to be user friendly for the customer',
        benefitbriefcase: 'Insurance <br><br>We provide insurance for all drivers',
      },
      vacancies: {
      ...
      faq: {
        ...
        answertwo: 'Depending on the logistics. Mostly when working with a refrigerator.',
        qthree: 'Do you have work on a refrigerator / with a container / on an auto transporter?',
        answerthree: 'We have more than 70 customers that we serve, there are refrigerators, platforms, containers, trawl.',
        ...
        answerfive: 'The company has its own transport to transport drivers from our offices to trucks. For free.',
        qsix: 'Where does the driver exchange take place and how does the truck transfer take place?',
        answersix: 'The driver exchange takes place in our garages. The truck is handed over to a mechanic.',
        qseven: 'Is any amount of money blocked for the period in which the driver is on leave?',
        answerseven: 'We have a full settlement with the drivers on the day of the salary. We do not block any amounts for the guarantee.',
    ...
    ro: {
      ...
      benefits: {
        ...
        benefitcogs: 'Condiții de lucru: 12 săptămânii la lucru, 3-4 săptămânii libere',
        benefitvan: 'Transport tur-retur din contul companiei',
        benefitglobe: 'Lucru în baza contractului și vizei de muncă direct de la angajator',
        benefitlanguage: 'Instruire flexibilă pentru șoferii noi cu experiență medie',
        benefitbook: 'Compania oferă cursuri de limbă engleză pentru a permite șoferilor comunicarea cu clienții și administrația. Cursurile de limba engleza sunt gratuite',
        benefitcap: 'Instruire și cursuri',
        benefitgift: 'Bonusuri interne',
        benefitmap: 'Întreaga noastră echipă este monitorizată și gestionată de propriul nostru sistem TMS, dezvoltat astfel încât să fie ușor de utilizat de către client',
        benefitbriefcase: 'Asigurare <br><br>Oferim asigurare pentru toți șoferii',
      },
      vacancies: {
      ...
      faq: {
        ...
        answertwo: 'În dependență de logistică. În mare parte atunci când lucrați cu refrigerator.',
        qthree: 'Este lucru pe refrigerator / cu container / pe un autotransportor?',
        answerthree: 'Avem peste 70 de clienți pe care îi deservim, există frigidere, platforme, container, traul.',
        ...
        answerfive: 'Compania are propriul transport pentru a transporta șoferii de la birourile noastre la camioane. Gratuit.',
        qsix: 'Unde are loc schimbul de șoferi și cum are loc transmiterea camionului?',
        answersix: 'Schimbul de șoferi are loc în garajele noastre. Camionul este predat unui mecanic.',
        qseven: 'Este blocata careva suma de bani pentru perioada in care soferul este in concediu?',
        answerseven: 'Avem o plată integrală șoferilor în ziua salariului. Nu blocăm nicio sumă pentru garanție.',
    ...
    ru: {
      ...
      benefits: {
        ...
        benefitbill: 'Привлекательная официальная заработная плата, рассчитанная за день',
        ...
        benefitglobe: 'Работа по контракту и рабочая виза напрямую от работодателя',
        benefitlanguage: 'Обучение для новых водителей со средним стажем',
        benefitbook: 'Компания предлагает курсы английского языка, которые позволят водителям общаться с клиентами и администрацией. Курсы английского языка бесплатны.',
        benefitcap: 'Обучение и курсы',
        benefitgift: 'Внутренние бонусы',
        benefitmap: 'Вся наша команда контролируется и управляется нашей собственной системой TMS, разработана для удобства использования заказчиком.',
        benefitbriefcase: 'Страховку <br><br>Мы предлагаем страховку для всех водителей',
      },
      vacancies: {
      ...
      faq: {
        ...
        answertwo: 'В зависимости от логистики. В основном при работе с холодильником.',
        qthree: 'Есть работа на холодильнике / с контейнером / на автовозе ?',
        answerthree: 'У нас более 70 клиентов которых мы обслуживаем, есть холодильники, термички, штора, платформа, контейнер, трал.',
        ...
        answerfive: 'Компания имеет свой транспорт для перевозки водителей с наших офисов и до грузовиках. Бесплатно',
        qsix: 'Где происходит обмен водителей, и как происходит сдача грузовика?',
        answersix: 'Обмен водителей проводится в наших гаражах. Грузовик сдается механику.',
        qseven: 'Блокируется какая нибудь сумма на период пока водитель в отпуске?',
        answerseven: 'У нас полный расчет с водителями в день зарплаты. Какие либо суммы для гарантии мы не блокируем.',
